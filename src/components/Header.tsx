...
export default function Header({ email }: { email: string }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white px-3 py-3 sm:px-6">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3">
        ...
        <nav className="flex shrink-0 items-center gap-2">
          ...
          <button
            ...
            className="rounded-md border border-slate-300 bg-white px-2.5 py-2 text-sm font-semibold text-slate-700 transition-colors hover:border-slate-400 hover:bg-slate-50 sm:px-3"
          >
            ログアウト
          </button>
        </nav>
